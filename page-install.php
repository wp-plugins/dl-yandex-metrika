...
<ol>
	...
	<p><img src="<?php echo plugins_url('dl-yandex-metrika/img/ym.jpg'); ?>" alt="Параметры которые необходимо отметить для приложения" style="max-width: 755px; width: 100%;">
